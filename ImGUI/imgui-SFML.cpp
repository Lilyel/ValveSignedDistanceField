...
void UpdateFontTexture()
{
    ...
    io.Fonts->TexID = (void*)((unsigned long long)texture.getNativeHandle());
}
...
void Image(const sf::Texture& texture, const sf::Vector2f& size,
    const sf::Color& tintColor, const sf::Color& borderColor)
{
    ImGui::Image((void*)((unsigned long long)texture.getNativeHandle()), size, ImVec2(0, 0), ImVec2(1, 1), tintColor, borderColor);
}
    ...
    const sf::Color& tintColor, const sf::Color& borderColor)
{
    ...
    ImGui::Image((void*)((unsigned long long)texture.getNativeHandle()), size, uv0, uv1, tintColor, borderColor);
}
                     ...
                     const sf::Color& bgColor, const sf::Color& tintColor)
{
    ...
    return ImGui::ImageButton((void*)((unsigned long long)texture.getNativeHandle()), size, uv0, uv1, framePadding, bgColor, tintColor);
}
